...
public class CultureService {
    ...
    public Map<String , Double> geocoding(String addr) {
    	...
    	try {
            ...
            conn.setRequestMethod("GET");
            conn.setRequestProperty("Content-type", "application/json");
            conn.setRequestProperty("X-NCP-APIGW-API-KEY-ID", "v0eoemweyq");//앱 등록 시 발급받은 Client ID
            conn.setRequestProperty("X-NCP-APIGW-API-KEY", "KTxrafUL11VWXT76BbiY30gRGEuc7hIzDE38KkJu");//앱 등록 시 발급 받은 Client Secret
